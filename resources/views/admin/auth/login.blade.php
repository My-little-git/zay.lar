...
@section('content')
    <form method="POST" action="{{ route('admin.login_process')}}" class="auth__form d-flex flex-column">
      <div class="mb-3">
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
        <button type="submit" class="ms-auto btn btn-success align-self-end">Войти</button>
      </div>
      @csrf
    </form>
@endsection